...
const message = db.collection("aboutmessage");
...
Page({
  ...
  onSubmit: function (e) {
    ...
    message.add({
      data: {
        ...
        geshou: e.detail.value.pageGeshou,
        geci: e.detail.value.pageGeci,
  ...
  getQ: function (e) {
    wx.cloud.callFunction({
      name: 'getQ',
      data: {
        path: `pages/aboutmsgPages/aboutmsgPages?id=${this.data.pageId}`,
        id: this.data.pageId,
      }
    }).then(res => {
      this.setData({
  ...
  copyPage: function (e) {
    wx.setClipboardData({
      data: `pages/aboutmsgPages/aboutmsgPages?id=${this.data.pageId}`,
      // success(res) {
      //   wx.getClipboardData({
      //     success(res) {
